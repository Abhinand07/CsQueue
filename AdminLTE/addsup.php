...
<head>
  ...
  <title>CS Queue | Add Support</title>
				...
				if($_GET['flag']==1)
					{
						...
						$d11= date("Y-m-d");
		$query11 = "INSERT INTO tbl_supp(s_id,problem,added_by,s_date,valid) VALUES('','$p_desc11','$id','$d11','0')";
			
			if(!mysqli_query($con,$query11))
			{
				echo "<script>alert('Failed to Report Problem'); window.location.href = 'addsup.php';</script>";
			}
			
			else
			{
				echo "<script>alert('Problem Reported Successfully'); window.location.href = 'addsup.php';</script>";
			...
			?>	
              <form role="form" method="POST" enctype="multipart/form-data" >
				...
				<div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" name="p_desc" placeholder="Report Question" required></textarea>
                </div>
				<!-- textarea -->
                   <label>Please raise your concern team will solve your problem as soon as possible</label>
				
			  <div class="box-footer" style="float:right;display: block;">
                <input type="submit" id="submit2" name="submit" value="ADD" class="btn btn-primary" formaction="addsup.php?flag=1">
              </div>
                  </div>				
